class ArtifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to project_url(id: @artifact.project_id), notice: 'Artifact was successfully created.' }
  ...
  def destroy
    @artifact.destroy
    respond_to do |format|
      format.html { redirect_to project_url(id: @artifact.project_id), notice: 'Artifact was successfully destroyed.' }
